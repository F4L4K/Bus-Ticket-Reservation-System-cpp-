...
public:
    ...
    void updateSeatAvailability(int bus_num, int
                                booked_seats);
...
void bus_reservation::updateSeatAvailability(int bus_num,
        int booked_seats)
{
...
void bus_reservation::showAvailableSeats()
{
    ...
    for (int i = 1; i <= 5; i++)
    {
        ...
        cout << "Bus " << bus_number << ": " <<
             available_seats[i*10] << " seats available\n";
    }
...
start1:
    cin >> bus.bus_num;
    if (bus.bus_num == 194210 || bus.bus_num == 194220
            || bus.bus_num == 194230 || bus.bus_num == 194240 ||
            bus.bus_num == 194250 )
    {
...
void bus_reservation::ticket(string name, int seat_num, int
                             bus_num, float price)
{
    bus_reservation bus;
